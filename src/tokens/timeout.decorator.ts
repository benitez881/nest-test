...
import { Timeout as NestTimeout } from '@nestjs/schedule';
import { AsyncContext } from '@nestjs-steroids/async-context';
import { LifecycleService } from './tokens.service';

export const TimeoutWithTokens = (timeout: number): MethodDecorator => {
  return (target, key, descriptor: PropertyDescriptor) => {
    ...
    NestTimeout(timeout)(target, key, descriptor);
  };
};
